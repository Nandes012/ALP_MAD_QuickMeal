...
const styles = StyleSheet.create({
  ...
  tabText: { fontSize: 22, color: '#1A1A1A', fontFamily: Platform.OS === 'android' ? 'inter' : 'Georgia' },
  sectionTitle: { textAlign: 'center', fontSize: 24, color: '#9E5F3B', marginTop: 20, marginBottom: 15, fontWeight: '600', fontFamily: Platform.OS === 'android' ? 'inter' : 'Georgia' },
